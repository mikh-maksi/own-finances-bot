...
bot = telepot.Bot('1369610345:AAHq-1NZ7ytIj08OfUTBmToedNPoh_AHiIA') #Между апострофами ставим сохраненный код доступа к боту
print(bot.getMe())
...
#     if msg["text"] == "привет":
#         bot.sendMessage(chat_id, "Привет, дружище!")
#     else:
#         bot.sendMessage(chat_id, "Моя - твоя  = не понимать")
...
>>>>>>> 53de6e3f1d42ac2dbf68ef7420097e8470f7cc49
